...
st.title("Professional Hotel Floor Plan Generator")
...
if st.button("Generate Floor Plan"):
    units = generate_double_corridor_plan(total_width, total_height, room_width, room_depth, corridor_width)
    svg_output = render_svg(units, total_width, total_height)
