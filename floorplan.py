...
def generate_auto_scaled_plan(total_width, total_height, room_aspect_ratio, corridor_width, room_metadata=None):
    ...
    units.append(Room(lobby_x + 0.5, lobby_y + lobby_depth, lift_width, lift_depth, "Lift-1"))
    units.append(Room(lobby_x + lobby_width - lift_width - 0.5, lobby_y + lobby_depth, lift_width, lift_depth, "Lift-2"))
